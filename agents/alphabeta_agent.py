class AlphaBetaAgent:
    ...
    def alphabeta(self, game, depth, alpha, beta, maximizing, root_player):
        ...
        if not valid_moves:
            return self.alphabeta(game, depth - 1, alpha, beta, not maximizing, root_player)[0], None
        ...
        if maximizing:
            ...
            for move in valid_moves:
                ...
                evaluation, _ = self.alphabeta(next_game, depth - 1, alpha, beta, False, root_player)
            ...
            return max_eval, best_move
                ...
                for move in valid_moves:
                    ...
                    evaluation, _ = self.alphabeta(next_game, depth - 1, alpha, beta, True, root_player)
